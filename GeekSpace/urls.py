...
urlpatterns = [
    ...
    path('crypto/delete/<int:pk>/', GameDeleteView.as_view(), name='GameDelete'),
       
    path('crypto/', CryptoList, name='CryptoList'),
    path('crypto/add-post', AddCPost, name='AddCPost'),
    path('crypto/update/<int:pk>/', CryptoUpdate, name='GameUpdate'),
    ...
    path('coding/update/<int:pk>/', CodeUpdate, name='GameUpdate'),
    ...
    path('anime/update/<int:pk>/', AnimeUpdate, name='GameUpdate'),
